...
parser.add_argument('--root_path', type=str, default='./data/DataProcess/station/1037A', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='1037A-2020-new.csv', help='data file')
parser.add_argument('--features', type=str, default='MS', help='forecasting task, options:[M, S, MS]; M:multivariate predict multivariate, S:univariate predict univariate, MS:multivariate predict univariate')
parser.add_argument('--target', type=str, default='CO', help='target feature in S or MS task')
...
data_parser = {
    ...
    'custom':{'data':'1037A-2020-new.csv','T':'CO','M':[6,6,6],'S':[1,1,1],'MS':[6,6,1]},
}
